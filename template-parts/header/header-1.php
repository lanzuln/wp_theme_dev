      <?php 
      $header_top_email= get_theme_mod('email','info@example.com');
      $header_top_phone= get_theme_mod('phone','+964 742 44 763');
      $header_top_timing= get_theme_mod('timing','Sunday-Thures 10am-07pm');
      ?>
      <!-- header area start -->
      <header>
                  ...
                  <div class="row align-items-center">
                     <div class="col-xxl-9 col-xl-9 col-lg-9 col-md-10">
                        <div class="header__info">
                           <ul>
                              <li>
                                 <a href="<?php echo esc_url($header_top_email);?>">
                                    <span>
                                    ...
                                    <?php echo esc_html($header_top_email);?>
                                 </a>
                              </li>
                              <li>
                                 <a href="tel:<?php echo esc_url($header_top_phone);?>">
                                    <span>
                                    ...
                                    <?php echo esc_html($header_top_phone);?>
                                 </a>
                              </li>
                              <li>
                                 <span>
                                    ...
                                    <?php echo esc_html($header_top_timing);?>
                                 </span>
                              </li>
                           </ul>
                        </div>
